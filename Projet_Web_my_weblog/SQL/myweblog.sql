...
--
-- Client :  127.0.0.1
-- Généré le :  Jeu 11 Décembre 2014 à 16:25
...
INSERT INTO `billet` (`id_billet`, `id_user`, `login`, `title`, `created`, `updated`, `content`, `tags`) VALUES
(1, 1, 'root', 'test du super-user', '2014-12-10', '2014-12-10', 'Ceci est juste un test de l''administrateur, veuillez ne pas en prendre compte. Merci, naviguez bien sur ce magnifique site. :)', '#test #superUser'),
(2, 2, 'groot', 'test groot', '2014-12-10', '2014-12-10', 'Je s''appelle Groot ?', '#Groot');
...
(7, 'Test01', 'test', 'mail', '0000-00-00', 'geek', '', '01', 'a94a8fe5ccb19ba61c4c0873d391e987982fbbd3', 2);
